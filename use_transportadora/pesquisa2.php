 ...
 <nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="pesquisa2.php"><h5>Pesquisa</h5></a></li>
    </ul>
          ...
          <div class="container-fluid">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                      ...
                      <?php
                        if(!empty($_SESSION['entregador_session'])){
                          echo $_SESSION['entregador_session'];
                        }
                      ?>
  ...
  <div class="content-wrapper">
      <div class="container">
          ...
          <div class="panel-body">
            <div class="col-md-12">
              <?php
              $entregador = $_SESSION['entregador_session'];
                              ...
                              <tbody>
                                ...
                                while ($msg =mysqli_fetch_array($query)) {
                                  ...
                                  <tr>
                                      ...
                                      <td><a href="editar2.php?idencomenda=<?=$msg['idencomenda'];?>">Editar</a></td>
                                  </tr>
                                  <?php
                                   $i++;
                                   }
